...
```{r, Hold-Out Testing for Online Error Simulation - Data Prep, results='hide', message=FALSE, include=FALSE, echo=FALSE}
###########################################
############# Prepare Offline
###########################################
...
```{r, Hold-Out Testing for Online Error Simulation - Model Construct, results='hide', message=FALSE, include=FALSE, echo=FALSE}
