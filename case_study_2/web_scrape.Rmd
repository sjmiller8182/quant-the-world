...
```
```{r}
men_2011<-extractResTable(url = urls[11], year = 2011, sex = 'male')
```
```{r}
men_2011[1:10]
```
```{r}
equals_idx<- grep('^===', men_2011)
equals_idx

equals_idx2<- substr(men_2011, 1,3)
which(equals_idx2 == '===')

spacerRow<- men_2011[equals_idx]
headerRow<- men_2011[equals_idx -1]
body<- men_2011[-(1:equals_idx)]
```
```{r}
head(body)
```
