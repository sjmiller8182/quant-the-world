...
p = ggplot(participation, aes(Group.1, runTime)) + 
  labs(title = 'Cherry Blossom Race Participation', caption = 'Figure 1: Cherry Blossom race participation with linear trend line') +
...
p = ggplot(runTime_by_year, aes(year, runTime)) + 
  labs(title = 'Average Run Time 1999 - 2012', caption = 'Figure 2: Average race finish time with linear trend line') +
