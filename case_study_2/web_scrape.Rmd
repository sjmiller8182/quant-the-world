...
```{r Global Map, include= TRUE, warning=F}
library(pacman)
...
```
```{r States Map, include= TRUE, warning=F}
...
plot_usmap(data = cherryblossom_sates_runtimes, values = "runTime",  labels=FALSE)   +
  ...
  labs(fill='Average Race Completion Time', title = "Average Race Completion Time, by US State")
```
