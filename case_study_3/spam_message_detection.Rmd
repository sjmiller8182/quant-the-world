...
Below, the Type I Error (rejecting the null hypothesis when the null hypothesis should not be rejected) level of significance is 0.01 and
the Type II Error (failing to reject the null hypothesis where the null hypothesis is true) is 0.05.
